...
RSpec.describe SponsoredPostsController, type: :controller do
  ...
  let(:my_sponsored_post) {
    my_topic.sponsored_posts.create!(
  ...
  describe 'GET #edit' do
    ...
    it 'assigns my_sponsored_post to be updated to @sponsored_post' do
      get :edit, params: {
        topic_id: my_topic.id,
        id: my_sponsored_post.id
      }
  ...
  describe 'PUT update' do
    it 'updates sponsored post with expected attributes' do
      ...
      put :update, params: {
        topic_id: my_topic.id, id: my_sponsored_post.id,
        sponsored_post: {
          title: new_title,
          body: new_body,
          price: new_price
